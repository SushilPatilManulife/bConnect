      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
               ...
               <?php
                    ...
                    $count++;
                    $dao = new MySQLDao();
                    $beacon = $dao->getBeaconFromID($row['b_id']);
                    $username = $dao->getUsernameFromBeacon($beacon);
                    $category = $dao->getCategory($row['category']); 
                    $sub_category = $dao->getSubCategory($row['sub_category']);
                    echo "";
                    echo "<tr>";
                    ...
                    echo "<td>".$row['exit_description']."</td>";
                    echo "<td>".$row['created_at']."</td>";
                    echo "<td>";
                    echo "<a href='' class='active' ui-toggle-class=''><i class='fa fa-check text-success text-active'></i><i class='fa fa-times text-danger text'></i></a>";
                    echo "</td>";
                    echo "</tr>";
