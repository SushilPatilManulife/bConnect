                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <form method="post" action="/Conc/web/userRegister.php" class="cmxform form-horizontal" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    <label for="mobile" class="control-label col-lg-3">Contact Number</label>
                                    <div class="col-lg-6">
