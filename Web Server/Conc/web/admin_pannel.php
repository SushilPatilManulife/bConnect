...
<body>
  <?php
    ...
    $dao = new MySQLDao();
    $beacon_count=$dao->getBeaconDetails();
    $user_count=$dao->getUserCount();
    ?>
	...
	<section class="wrapper">
	   <div class="market-updates">
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-2">
					<div class="col-md-4 market-update-right">
					 ...
					 <h4>iBeacons Available</h4>
					<h3>0</h3>
					<p>Are available for deployment</p>
				  </div>
			...
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-1">
					...
					<h4>Assigned users </h4>
						<h3><?=$user_count?></h3>
						<p>Active users are using our service</p>
					</div>
				  <div class="clearfix"> </div>
				</div>
			</div>
        ...
        <div class="market-updates">
         ...
         <div class="col-md-3 market-update-gd">
              <a href="addNewBeacon.php?username=<?=$username?>">
				<div class="market-update-block clr-block-4">
					<div class="col-md-4 market-update-right">
						<i class="fa fa-usd" ></i>
					</div>
					<div class="col-md-8 market-update-left">
					<h4>Add new iBeacon </h4>
            ...
            <div class="col-md-3 market-update-gd">
                <a href="addNewUser.php?username=<?=$username?>">
				<div class="market-update-block clr-block-4">
					<div class="col-md-4 market-update-right">
						<i class="fa fa-users" ></i>
					</div>
					...
					<h4>Add new user </h4>
						...
						<p>Click here to add new user</p>
					</div>
				  <div class="clearfix"> </div>
                    </div></a>
			</div>
