      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
               ...
               <?php
                    ...
                    $query  = "select * from login INNER JOIN beacon_information ON login.u_id=beacon_information.u_id INNER JOIN notification_information ON notification_information.b_id=beacon_information.b_id INNER JOIN sub_category ON notification_information.sub_category=sub_category.subCat_id INNER JOIN category ON notification_information.category=category.cat_id where login.username='".$username."'";
                    $count=0;
