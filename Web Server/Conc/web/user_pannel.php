	...
	<section class="wrapper">
	    <div class="market-updates">
			...
			<div class="col-md-3 market-update-gd">
                <a href="category_home.php?username=<?= $username?>&u_id=<?=$u_id?>&cat_id=1">
			...
			<div class="col-md-3 market-update-gd">
                 <a href="category_home.php?username=<?= $username?>&u_id=<?=$u_id?>&cat_id=2">
         ...
         <div class="market-updates">
             <div class="col-md-3 market-update-gd"></div>
             <div class="col-md-3 market-update-gd">
                 <a href="category_home.php?username=<?= $username?>&u_id=<?=$u_id?>&cat_id=3">
